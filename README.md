...
```diff
+ An improved Model (the Hierarchical Probabilistic U-Net) + our LIDC data is now available. See [below](#cross-link-to-the-hierarchical-probabilistic-u-net-and-lidc-crops).
```
 :point_down:
...
## Cross-link to the Hierarchical Probabilistic U-Net and LIDC crops
