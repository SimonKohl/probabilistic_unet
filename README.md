...
```diff
+ An improved Model (the Hierarchical Probabilistic U-Net) + our LIDC data is now available. See [below](hpu-net). :point_down:
```
...
## [Cross-link: The Hierarchical Probabilistic U-Net + LIDC crops](#hpu-net)
